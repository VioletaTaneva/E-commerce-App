...
const Page = () => {
    ...
    return (
        <View className="flex-1">
            {/* LinearGradient component to create a gradient background */}
            <LinearGradient
            ...
            >
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View>
                        {/* Map over the AFFIRMATION_GALLERY data to render a list of GuidedAffirmationsGallery components */}
